	...
	Buttons = {
		{
			...
			Callback = function()
				setclipboard("https://discord.gg/f3hTH8Y6MJ");
				WindUI:Notify({
					Title = "Notication",
...
AutoKillTyrantOfTheSkiesToggle = Tabs.MainTab:Toggle({
    ...
    Desc = "Tự Động Đánh Boss Chim Mới",
	Default = false,
	Callback = function(state)
